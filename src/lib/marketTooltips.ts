...
export function getMarketTooltips(marketId: string) {
  ...
  return {
    ...
    collateral:
      `The Collateral Configuration defines the ratio of €BSR to eEURO used as margin to open a new position. Every position in the BlackSlon Protocol is backed by a dual-asset collateral portfolio — here, for buying and selling ${m.token}. The higher the proportion of €BSR in your collateral, the lower your required % margin and trading fees — and the higher your available leverage. At 100% €BSR, the margin requirement drops to 25% for long positions and fees fall to 0.20%. At 10% €BSR, the margin requirement is 50% and fees are 1.00%. This tiered system aligns protocol sustainability with user capital efficiency — staking more €BSR signals long-term commitment and is rewarded with better trading conditions. When closing a position, the closing fee is a flat 0.20% of the position's notional value, regardless of your €BSR ratio.`,
