      ...
      <div className="flex-grow px-6 pb-6 flex flex-col min-h-0">
        <div className="p-4 bg-gradient-to-b from-black to-gray-950">
          ...
          <div className="space-y-2">
            ...
            <div className="border border-blue-500/30 rounded-sm p-3">
              <div className="text-[8px] text-blue-800 uppercase tracking-widest mb-1">€BSR BALANCE: <span className="text-lg text-blue-500 tracking-tighter">3 200.00</span></div>
            </div>
          </div>
